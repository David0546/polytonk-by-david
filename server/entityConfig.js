exports.entityTypes = [{
  ...
  bodyShape: 0,
  fieldFactor: 1,
  barrels: [{ angle: 0, offset: 0, height: 1.8, width: 0.9, recoil: 1, delay: 0, reload: 8, bullet: { damageFactor: 1000, rangeFactor: 1, penFactor: 1000, spdFactor: 1, }, }],
}];
exports.stringEntityTypes = {};
exports.upgradeTree = {
  Tank: {
    tier1: ["Twin", "Sniper", "Machine Gun", "Flank Guard", "A"],//, "Mothership", "Dominator", "Arena Closer"],
    tier2: ["Smasher"]
  },
  Smasher: {
    tier3: ["Mega Smasher"],
  ...
  "Flank Guard": {
    tier2: ["Quad Tank", "Triple Shot", "Tri-Angle", "UC0", "Twin Flank"],
  },
  "Tri-Angle": {
    tier3: ["UC1", "Booster", "Fighter"],
  },
  UC0: {
    tier3: ["UC1"],
  },
